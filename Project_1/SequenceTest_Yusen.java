// Created by: Yusen Jiang, Sydeny McDaniel, Afeique Sheikh

//This class will present the user with a menu for different options that will test all of the methods in the DoubleArraySeq class.
//There are two arrays that are already created and then presented to the user for them to use in the testing process.
//Some of the options, such as 5, 6, 7, 8, 10, and 12 will ask for user input and then use that to complete the task.
//Other methods are simply activated and then the action is completed, depending on which option is chosen, the results
//will be printed out for the user to see. This is to ensure that the correct action was performed.
//Throughout the code there are exceptions thrown to further ensure that the methods are tested properly and the input given is 
//the correct input for that scenario.
...
public class SequenceTest {
	...
	public static void PrintMenu() {
		...
		System.out.println("15. Create a clone of the ACTIVE sequence and show");
	...
	public static void main(String [] arg)
	{
		...
		while (true) {
			...
			/*	case 10:
				...
				case 12:
					System.out.println("\nEnter the index number your looking for "+ SequenceTest.activeAlpha +": ");
					index = scanner.nextInt();
				...
				case 15:
					...
					System.out.printf("ACTIVE SEQUENCE CLONE: %s", copy.toString());
					break;
				case 16:
					break;
				case 17:
